		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					instance = (GameplayScripts.DryerMachine)reader.SetPrivateField("nextLevelMachine", reader.Read<GameplayScripts.Machine>(), instance);
					break;
					case "animator":
					...
					instance = (GameplayScripts.DryerMachine)reader.SetPrivateField("_currentCustomer", reader.Read<GameplayScripts.Customer>(), instance);
					break;
					...
					break;
					case "_customerItems":
					instance = (GameplayScripts.DryerMachine)reader.SetPrivateField("_customerItems", reader.Read<GameplayScripts.CustomerItem>(), instance);
					break;
					case "_workedTime":
